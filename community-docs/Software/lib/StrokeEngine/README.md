...
### Advanced Functions
Consult [StrokeEngine.h](../../../../Software/lib/StrokeEngine/src/StrokeEngine.h) for further functions and a more detailed documentation of each function. Some functions are overloaded and may provide additional useful functionalities.
#### Telemetry
