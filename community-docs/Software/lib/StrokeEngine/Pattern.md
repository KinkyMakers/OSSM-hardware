...
Making your own pattern is not that hard. They can be found in the header only [pattern.h](../../../../Software/lib/StrokeEngine/src/pattern.h) and easily extended.
...
### Pull Request
Make a pull request for your new [pattern.h](../../../../Software/lib/StrokeEngine/src/pattern.h) after you thoroughly tested it. 
