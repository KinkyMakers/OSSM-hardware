...
<Tip>
If you have a smaller improvement or bug fix, consider [opening a pull request](/guides/contributing/how-to-become-a-contributor) directly instead of forking.
</Tip>
...
<Card title="Become a contributor" icon="code-pull-request" href="/guides/contributing/how-to-become-a-contributor">
