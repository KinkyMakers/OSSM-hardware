...
- **BLE WiFi Configuration** — Configure WiFi credentials wirelessly via Bluetooth using the Web BLE Controller, no wired remote required
- **Web Controller UI Improvements** — Redesigned interface with tabbed navigation for Controller, WiFi Settings, and Raw Logs
