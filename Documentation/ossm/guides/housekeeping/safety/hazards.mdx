...
<AccordionGroup>
  ...
  <Accordion title="Untrusted or malicious streaming data" icon="broadcast-tower">
    **Vulnerability:** In streaming mode, external applications send real-time position commands. A malicious or buggy application could send rapid, extreme position changes.

    **Likely consequences:** Unexpected rapid motion; potential tissue trauma or internal injury.
