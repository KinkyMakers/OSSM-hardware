...
<Note>
**Streaming mode safety:** Streaming mode (experimental) accepts real-time position commands from external applications via Bluetooth. Only use streaming with trusted applications from known sources. Always test at low intensity first, and keep physical stop controls accessible. See [Operating Modes](/ossm/Software/getting-started/operating-modes#streaming-mode-experimental) for details.
</Note>
