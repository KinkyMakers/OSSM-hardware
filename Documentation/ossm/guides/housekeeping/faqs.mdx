...
<Note>
**Is a physical remote required?** No. If you prefer app-based control, you can skip the wired or wireless remote and use xToys instead. xToys connects directly to your OSSM via Bluetooth and provides full control including custom patterns, multi-toy coordination, and scripted interactions.
</Note>
</Accordion>
