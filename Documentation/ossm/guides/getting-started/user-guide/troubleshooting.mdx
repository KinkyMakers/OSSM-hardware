...
See the [motor programming guide](/Hardware/motor/programming) for detailed instructions.
</Step>
...
**Solution:**
Reconnect any loose wiring following the [wiring guide](/guides/getting-started/build-guide/step-11.0_wiring). If wires are damaged, replace them before operating.
</Accordion>
...
**Solution:**
Adjust the belt tension following the [tension adjustment guide](/guides/getting-started/build-guide/step-9.0_tension_adjustment). The belt should be tight enough to prevent slipping but not so tight that it strains the motor.
...
<CardGroup cols={2}>
<Card title="Report an issue" icon="bug" href="/guides/contributing/reporting-issues">
