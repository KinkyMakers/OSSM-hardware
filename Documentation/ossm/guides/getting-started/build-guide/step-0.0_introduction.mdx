...
The frame is the structural stand that holds and positions the actuator. You can build on the basic mount or an extrusion stand depending on your setup. See <a href="/ossm/guides/getting-started/quickstart">
OSSM: Basic Mount V2</a>
...
<Steps>
  ...
  <Step title="Wire power and data">
    Connect the motor power and PH04 data cables to the board. Follow the wiring order in <a href="/open-source-sex-machine/ossm-electronics/wiring-your-gold-motor">
  ...
  <Step title="Initial firmware + motion test">
    Power the OSSM, allow it to home, then run a short test at low speed. If needed, update firmware using <a href="/open-source-sex-machine/flashing-your-ossm">
    Flashing your OSSM</a>
...
- Review wiring and firmware pages so you’re ready when you reach those steps:
  - <a href="/open-source-sex-machine/ossm-electronics/wiring-your-gold-motor">
    Wiring Your Gold Motor</a>
  - <a href="/open-source-sex-machine/flashing-your-ossm">
    Flashing your OSSM</a>
- If you haven’t chosen a stand yet, see <a href="/ossm/guides/getting-started/quickstart">
  OSSM: Basic Mount V2</a>
