...
<Tip>
For detailed PlatformIO setup instructions, see our [PlatformIO setup guide](PlatformIO).
</Tip>
</Step>
...
<CardGroup cols={2}>
<Card title="PlatformIO Setup" icon="wrench" href="PlatformIO">
Detailed guide for configuring PlatformIO, managing libraries, and troubleshooting build issues.
</Card>

<Card title="LED Status Codes" icon="lightbulb" href="LED_Status">
Learn what the LED indicators mean and how to diagnose common issues.
</Card>
</CardGroup>