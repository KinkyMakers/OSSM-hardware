...
<Frame caption="StrokeEngine coordinate system showing physical travel, keepout boundaries, and stroke parameters">
  <img src="https://github.com/theelims/StrokeEngine/blob/main/doc/coordinates.svg" alt="Coordinate system diagram showing the relationship between physicalTravel, keepoutBoundary, depth, and stroke parameters" />
</Frame>
