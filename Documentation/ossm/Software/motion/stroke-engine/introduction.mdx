...
<Frame caption="StrokeEngine coordinate system showing physical travel, keepout boundaries, and stroke parameters">
  <img src="doc/coordinates.svg" alt="Coordinate system diagram showing the relationship between physicalTravel, keepoutBoundary, depth, and stroke parameters" />
</Frame>
...
<Info>
See the [Pattern documentation](Pattern.md) for detailed descriptions of available patterns and instructions for creating your own.
</Info>
...
<Note>
Consult [StrokeEngine.h](src/StrokeEngine.h) for the complete API reference, including overloaded functions and additional features.
</Note> 
