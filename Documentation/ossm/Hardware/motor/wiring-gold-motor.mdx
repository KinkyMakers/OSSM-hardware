...
**Included components:**
- Green connector (6-position screw terminal block)
- PH04 Cable (4-wire signal cable with white JST connector)
- 250mm 18AWG power cable (2-wire, red and black)
- Wiring sleeve (optional)

<Note>
The green connector is a 6-position screw terminal block that accommodates all 6 wires: 2 from the power cable and 4 from the PH04 signal cable. No crimping required—simply insert stripped wires and tighten the screws.
</Note>
