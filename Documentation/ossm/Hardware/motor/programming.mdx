...
1. Download the `GMP` folder from the [OSSM hardware repository](https://github.com/KinkyMakers/OSSM-hardware/tree/master/ossm/Hardware/Servo%20Tools/Gold%20Motor)
...
The Python script writes default settings to the Gold Motor and displays current configuration. Find it in the [OSSM hardware repository](https://github.com/KinkyMakers/OSSM-hardware/tree/master/ossm/Hardware/Servo%20Tools/Gold%20Motor).
