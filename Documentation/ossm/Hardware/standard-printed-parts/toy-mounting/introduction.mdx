...
<Card title="Flange ring" icon="ring" href="#flange-ring-mounting">
...
Use this when your toy has a suction-cup base with a flange. This system sandwiches the toy's flange between two printed parts and secures it with paracord.
...
<Step title="Secure with paracord">
