...
<Frame caption="OSSM reference board (version 1) - front view showing component placement">
  <img src="https://user-images.githubusercontent.com/43324815/150361448-80e9fdaf-4a8c-4054-a920-6eab9aa68678.png" alt="OSSM version 1 reference board showing ESP32 socket, level shifters, and JST connectors" />
</Frame>

### PCB Connection Diagram

<Frame caption="Connection diagram showing motor driver and peripheral connections">
  <img src="https://user-images.githubusercontent.com/43324815/150355658-2ab2c53f-8da0-41ce-ad61-cfe9965b9ab2.png" alt="OSSM PCB connection diagram with labeled motor driver output, encoder input, and power connections" />
</Frame>
...
<Frame caption="ESP32 GPIO pinout showing control signal routing">
  <img src="https://user-images.githubusercontent.com/12459679/152600401-80b986ea-6f5b-480d-ba74-5b5001079c1b.png" alt="OSSM GPIO pinout diagram showing step, direction, and enable pins on ESP32" />
</Frame>

<Frame caption="JST header locations with pin labels for easy identification">
  <img src="https://user-images.githubusercontent.com/12459679/226189433-db28dfc6-22ac-4fdb-8b45-afe0c3fa9a7b.png" alt="JST connector header locations on the OSSM PCB showing motor output, encoder input, and auxiliary connections" />
</Frame>
...
<Frame caption="Wiring diagram for TB6600 stepper driver with OSSM controller">
  <img src="https://user-images.githubusercontent.com/43324815/159145946-a9960bba-c9bc-4717-b3b4-5b5c34b4a3d2.png" alt="Connection diagram showing OSSM PCB signal outputs wired through level shifter to TB6600 stepper motor driver inputs" />
</Frame>
...
<Frame caption="Servo motor wiring configuration showing step/direction interface">
  <img src="https://github.com/NightmareSyndrome/OSSM-hardware/assets/131713378/783876cf-f5bf-4708-9b4f-bd89723713f9" alt="Wiring diagram for closed-loop servo motor connection to OSSM controller via step/direction interface" />
</Frame>
