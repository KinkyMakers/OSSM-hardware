...
// #define INITIAL_SETUP //should only be defined at initial burn to configure
// HW version
...
/*
    User Config for OSSM - Reference board users should tweak this to match
   their personal build.
*/
...
// N.b. the iHSV57 has a table on the side for setting the DIP switches to your
// preference.
...
// Set to your belt pitch (Distance between two teeth on the belt) (E.g. GT2
// belt has 2mm tooth pitch)
const float hardcode_beltPitchMm = 2.0f;
// This is in millimeters, and is what's used to define how much of
// your rail is usable.
// The absolute max your OSSM would have is the distance between the belt
// attachments subtract the linear block holder length (75mm on OSSM)
// Recommended to also subtract e.g. 20mm to keep the backstop well away from
// the device.
...
/*
        Advanced Config
*/
// After homing this is the physical buffer distance from the effective zero to
// the home switch This is to stop the home switch being smacked constantly
