    ...
    auto operator()() const {
        ...
        // clang-format off
            ...
            *"idle"_s + done / drawHello = "homing"_s,
            ...
            "homing.forward"_s + emergencyStopEvent / (emergencyStop, setNotHomed) = "menu"_s,
            "homing.forward"_s + done / startHoming = "homing.backward"_s,
            "homing.backward"_s + error = "error"_s,
            "homing.backward"_s + emergencyStopEvent / (emergencyStop, setNotHomed) = "menu"_s,
            ...
            "menu"_s / (drawMenu, clearRemoteMenuAction) = "menu.idle"_s,
            ...
            "menu.idle"_s + buttonPress[(isOption(Menu::Pairing)) && !isOnline && isRemoteMenuAction] / (setNetworkError("wifi"), drawPairingFailed) = "pairing.failed"_s,
            ...
            "menu.idle"_s + home / setNotHomed = "homing"_s,
            ...
            "simplePenetration.preflight"_s + returnToMenu = "menu"_s,
            "simplePenetration.preflight"_s + emergencyStopEvent / setNotHomed = "menu"_s,
            "simplePenetration.preflight"_s + home / setNotHomed = "homing"_s,
            ...
            "simplePenetration.idle"_s + emergencyStopEvent / (emergencyStop, setNotHomed) = "menu"_s,
            "simplePenetration.idle"_s + home / (emergencyStop, setNotHomed) = "homing"_s,
            ...
            "strokeEngine.preflight"_s + emergencyStopEvent / setNotHomed = "menu"_s,
            "strokeEngine.preflight"_s + home / setNotHomed = "homing"_s,
            "strokeEngine.idle"_s + emergencyStopEvent / (emergencyStop, setNotHomed) = "menu"_s,
            "strokeEngine.pattern"_s + emergencyStopEvent / (emergencyStop, setNotHomed) = "menu"_s,
            "strokeEngine.idle"_s + home / (emergencyStop, setNotHomed) = "homing"_s,
            "strokeEngine.pattern"_s + home / (emergencyStop, setNotHomed) = "homing"_s,
            ...
            "streaming.preflight"_s + returnToMenu = "menu"_s,
            "streaming.preflight"_s + emergencyStopEvent / setNotHomed = "menu"_s,
            "streaming.preflight"_s + home / setNotHomed = "homing"_s,
            "streaming.idle"_s + emergencyStopEvent / (emergencyStop, setNotHomed) = "menu"_s,
            "streaming.idle"_s + home / (emergencyStop, setNotHomed) = "homing"_s,
            ...
            "pairing.idle"_s + error / drawPairingFailed = "pairing.failed"_s,
            "pairing.idle"_s + returnToMenu = "menu"_s,
            "pairing.failed"_s + buttonPress = "menu"_s,
            "pairing.failed"_s + longPress = "menu"_s,
            "pairing.failed"_s + returnToMenu = "menu"_s,
            ...
            "pairing.success.idle"_s + returnToMenu = "menu"_s,
            ...
            "pairing.wifi.idle"_s + returnToMenu / stopWifiPortal = "menu"_s,

            "update"_s [isOnline] / (drawUpdate, startUpdate) = "update.checking"_s,
            "update"_s [isRemoteMenuAction] / (setNetworkError("wifi"), drawUpdateFailed) = "update.failed"_s,
            "update"_s = "wifi"_s,
            "update.checking"_s + updateUnavailable / drawNoUpdate = "update.idle"_s,
            "update.checking"_s + updateAvailable / drawUpdateAvailable = "update.available"_s,
            "update.checking"_s + updateFailed / drawUpdateFailed = "update.failed"_s,
            "update.available"_s + buttonPress / (drawUpdating, startInstall) = "update.installing"_s,
            "update.available"_s + longPress = "menu"_s,
            "update.available"_s + returnToMenu = "menu"_s,
            "update.installing"_s + updateFailed / drawUpdateFailed = "update.failed"_s,
            "update.idle"_s + buttonPress = "menu"_s,
            "update.idle"_s + returnToMenu = "menu"_s,
            "update.failed"_s + buttonPress = "menu"_s,
            "update.failed"_s + returnToMenu = "menu"_s,
            ...
            "wifi.idle"_s + returnToMenu / stopWifiPortal = "menu"_s,

            "help"_s / drawHelp = "help.idle"_s,
            "help.idle"_s + buttonPress = "menu"_s,
            "help.idle"_s + returnToMenu = "menu"_s,
