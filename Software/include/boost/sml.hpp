...
namespace aux {
    ...
    struct zero_wrapper<R (TBase::*)(TArgs...) const, T> {
        constexpr explicit zero_wrapper(R (TBase::*ptr)(TArgs...) const)
            : ptr{ptr} {}
        constexpr auto operator()(TBase &self, TArgs... args) {
            return (self.*ptr)(args...);
        }
    ...
    struct zero_wrapper<R (TBase::*)(TArgs...) noexcept, T> {
        constexpr explicit zero_wrapper(R (TBase::*ptr)(TArgs...) noexcept)
            : ptr{ptr} {}
        constexpr auto operator()(TBase &self, TArgs... args) {
            return (self.*ptr)(args...);
        }
    ...
    struct zero_wrapper<R (TBase::*)(TArgs...) const noexcept, T> {
        constexpr explicit zero_wrapper(R (TBase::*ptr)(TArgs...)
                                            const noexcept)
            : ptr{ptr} {}
        constexpr auto operator()(TBase &self, TArgs... args) {
            return (self.*ptr)(args...);
